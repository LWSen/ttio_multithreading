...
`endif//}
`ifdef E203_CFG_SUPPORT_TTIO
  `define E203_SUPPORT_TTIO
`endif
...
`ifdef E203_SUPPORT_TTIO
  `define E203_DECINFO_GRP_TTIO     `E203_DECINFO_GRP_WIDTH'd7
`endif
...
*/
  ...
  // TTIO group
`ifdef E203_SUPPORT_TTIO
      `define E203_DECINFO_TTIO_RTIDX_LSB   (`E203_DECINFO_SUBDECINFO_LSB)
      `define E203_DECINFO_TTIO_RTIDX_MSB   (`E203_DECINFO_TTIO_RTIDX_LSB+3-1)
  `define E203_DECINFO_TTIO_RTIDX   `E203_DECINFO_TTIO_RTIDX_MSB : `E203_DECINFO_TTIO_RTIDX_LSB
  
      `define E203_DECINFO_TTIO_SETTR_LSB   (`E203_DECINFO_TTIO_RTIDX_MSB+1)
      `define E203_DECINFO_TTIO_SETTR_MSB   (`E203_DECINFO_TTIO_SETTR_LSB+1-1)
  `define E203_DECINFO_TTIO_SETTR   `E203_DECINFO_TTIO_SETTR_MSB :`E203_DECINFO_TTIO_SETTR_LSB
      `define E203_DECINFO_TTIO_SETTI_LSB   (`E203_DECINFO_TTIO_SETTR_MSB+1)
      `define E203_DECINFO_TTIO_SETTI_MSB   (`E203_DECINFO_TTIO_SETTI_LSB+1-1)
  `define E203_DECINFO_TTIO_SETTI   `E203_DECINFO_TTIO_SETTI_MSB :`E203_DECINFO_TTIO_SETTI_LSB
      `define E203_DECINFO_TTIO_GETTI_LSB   (`E203_DECINFO_TTIO_SETTI_MSB+1)
      `define E203_DECINFO_TTIO_GETTI_MSB   (`E203_DECINFO_TTIO_GETTI_LSB+1-1)
  `define E203_DECINFO_TTIO_GETTI   `E203_DECINFO_TTIO_GETTI_MSB :`E203_DECINFO_TTIO_GETTI_LSB
  
      `define E203_DECINFO_TTIO_MOVE_LSB    (`E203_DECINFO_TTIO_GETTI_MSB+1)
      `define E203_DECINFO_TTIO_MOVE_MSB    (`E203_DECINFO_TTIO_MOVE_LSB+1-1)
  `define E203_DECINFO_TTIO_MOVE    `E203_DECINFO_TTIO_MOVE_MSB : `E203_DECINFO_TTIO_MOVE_LSB
      `define E203_DECINFO_TTIO_TTIAT_LSB   (`E203_DECINFO_TTIO_MOVE_MSB+1)
      `define E203_DECINFO_TTIO_TTIAT_MSB   (`E203_DECINFO_TTIO_TTIAT_LSB+1-1)
  `define E203_DECINFO_TTIO_TTIAT   `E203_DECINFO_TTIO_TTIAT_MSB :`E203_DECINFO_TTIO_TTIAT_LSB
      `define E203_DECINFO_TTIO_TTOAT_LSB   (`E203_DECINFO_TTIO_TTIAT_MSB+1)
      `define E203_DECINFO_TTIO_TTOAT_MSB   (`E203_DECINFO_TTIO_TTOAT_LSB+1-1)
  `define E203_DECINFO_TTIO_TTOAT   `E203_DECINFO_TTIO_TTOAT_MSB :`E203_DECINFO_TTIO_TTOAT_LSB
  //     `define E203_DECINFO_TTIO_TTIAF_LSB   (`E203_DECINFO_TTIO_TTOAT_MSB+1)
  //     `define E203_DECINFO_TTIO_TTIAF_MSB   (`E203_DECINFO_TTIO_TTIAF_LSB+1-1)
  // `define E203_DECINFO_TTIO_TTIAF   `E203_DECINFO_TTIO_TTIAF_MSB :`E203_DECINFO_TTIO_TTIAF_LSB
  //     `define E203_DECINFO_TTIO_TTOAF_LSB   (`E203_DECINFO_TTIO_TTIAF_MSB+1)
  //     `define E203_DECINFO_TTIO_TTOAF_MSB   (`E203_DECINFO_TTIO_TTOAF_LSB+1-1)
  // `define E203_DECINFO_TTIO_TTOAF   `E203_DECINFO_TTIO_TTOAF_MSB :`E203_DECINFO_TTIO_TTOAF_LSB
  `define E203_DECINFO_TTIO_WIDTH    (`E203_DECINFO_TTIO_TTOAT_MSB+1)
  
  // `define E203_DECINFO_TTIO_WIDTH    (`E203_DECINFO_TTIO_TTOAF_MSB+1)
